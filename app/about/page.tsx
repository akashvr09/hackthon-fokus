          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  { icon: Zap, title: "Innovation", desc: "Cutting-edge formulations" },
                  { icon: Target, title: "Performance", desc: "Peak human potential" },
                  { icon: Users, title: "Community", desc: "Global movement" },
                  { icon: Award, title: "Quality", desc: "Premium ingredients" },
                ].map((item, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-purple-400 flex items-center justify-center flex-shrink-0">
            ...
            >
              <div className="relative p-8 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  <motion.div
                    className="w-32 h-48 mx-auto mb-6 rounded-2xl bg-gradient-to-b from-cyan-400 to-purple-600 shadow-2xl"
                    animate={{
                      rotateY: [0, 15, -15, 0],
                      scale: [1, 1.05, 1],
                    }}
            ...
            <div className="space-y-16">
              {timelineEvents.map((event, index) => (
                ...
                >
                  ...
                  {/* Timeline Node */}
                  <motion.div
                    className="relative z-10 w-6 h-6 rounded-full bg-gradient-to-r from-cyan-400 to-purple-400 shadow-lg shadow-cyan-500/50"
      ...
      <section className="py-20 px-4">
        ...
        >
          ...
          <div className="relative">
            ...
            >
              <motion.div
                className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-cyan-400 to-purple-400 overflow-hidden"
                ...
                {testimonials.map((_, index) => (
                  <motion.button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      index === currentTestimonial ? "bg-gradient-to-r from-cyan-400 to-purple-400" : "bg-white/20"
                    }`}
